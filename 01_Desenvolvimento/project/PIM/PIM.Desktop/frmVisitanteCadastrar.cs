...
{
    public partial class frmVisitanteCadastrar : Form
    {
        public frmVisitanteCadastrar()
        {
            InitializeComponent();
        }
        ...
        private bool ValidarCampos(out string erro)
        {
            ...
            {
                msgErro += "Preenchimento do Nome do Visitante obrigatório\n";
            }

            if (string.IsNullOrEmpty(txtCodVisitante.Text))
            {
                msgErro += "Preenchimento do Código do Visitante obrigatório\n";
            }
        ...
        private void btnSalvarVisit_Click(object sender, EventArgs e)
        {
            ...
            visitanteTO.Identificador = Convert.ToInt32(txtCodMorVisit.Text);
